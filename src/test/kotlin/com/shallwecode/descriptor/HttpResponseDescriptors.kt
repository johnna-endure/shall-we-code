...
class HttpResponseDescriptors {
    companion object {
         ...
         */
        fun httpResponseDescriptors(vararg bodyDescriptor: FieldDescriptor): Array<FieldDescriptor> {
            return arrayOf(
         ...
         * @param bodyDescriptor 추가적으로 필요한 응답 body의 FieldDescriptor
         */
        fun httpErrorResponseDescriptors(vararg bodyDescriptor: FieldDescriptor): Array<FieldDescriptor> {
            return arrayOf(
